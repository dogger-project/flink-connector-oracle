 ...
 */
package io.terminus.fdp.flink.oracle.connector.writer;


import io.terminus.fdp.flink.oracle.config.OracleProperties;
import io.terminus.fdp.flink.oracle.connector.OracleTable;
import io.terminus.fdp.flink.oracle.connector.OracleTableInfo;
import io.terminus.fdp.flink.oracle.connector.failure.DefaultOracleFailureHandler;
import io.terminus.fdp.flink.oracle.connector.failure.OracleFailureHandler;
import io.terminus.fdp.flink.oracle.jdbc.OracleClient;
import io.terminus.fdp.flink.oracle.utils.TableUtils;
    ...
    private OracleTable obtainTable()  {
        ...
        try {
            if (client.tableExists(tableName)) {
                ...
                throw new UnsupportedOperationException("table not exists and is marketed to not be created" + tableName);
